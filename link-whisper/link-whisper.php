...
define( 'WPIL_VERSION_NUMBER', '0.9.7');
define( 'WPIL_PLUGIN_VERSION_NUMBER', '0.9.7');
define( 'WPIL_PLUGIN_OLD_VERSION_NUMBER', '0.9.6');
...
define('WPIL_STATUS_PLUGIN_DB_VERSION', '1.57');  // simple version counter that gets incremented when we change the existing DB tables. That way update_tables knows when and what to update.
